...
const OLDFrame31 = () => {
  ...
  const handleProceed = () => {
    ...
    navigate("/OFrame32", { state: SearchResults });
  ...
  const sendSymptomsToBackend = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:5000/search?Fname=${stateData.Fname}&Phnumber=${stateData.Phnumber}`);
          ...
          <Row className="d-flex justify-content-center">
            <Col sm={6} className="ccc">
              ...
              <form action="">
                ...
                >
                  <Form.Label> <strong> Pridicted Disease </strong></Form.Label>
                  <Form.Control
                    // className="Formcontroll"
                    as="textarea"
                    rows={3}
                    value={recommendedMedicines}
                    // onInput={handleDiseasePredictionChange}
                    readOnly
                  />
              ...
              <div className="d-flex flex-column">
                <div className="d-flex mb-2">
                  ...
                  <button
                    onClick={handleBack}
                    className="btn btn-primary exc22"
                  >
                    Go Back
                  </button>
